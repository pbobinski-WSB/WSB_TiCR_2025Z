...
import testCase.LoginController;
import testCase.LoginDao;
import testCase.LoginService;
import testCase.UserForm;


@RunWith(EasyMockRunner.class)
public class LoginControllerIntegrationTestEm {
